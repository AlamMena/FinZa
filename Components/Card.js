...
export default function Card({active}) {
  return (
    ...
    //   <div className=" flex flex-col rounded-l-2xl bg-neutral-800 text-white py-8 px-4 w-full">
    ...
    //   </div>
    //   <div className={`${active ? 'bg-purple-300':'bg-green-200'} rounded-r-2xl px-4 flex flex-col justify-between py-4`}>
